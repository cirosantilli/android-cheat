...
#define TAG "NativeCodecMinimized"
...
static workerdata data = {-1, NULL, NULL, NULL, 0, false, false, false, false};
...
jboolean Java_com_cirosantilli_android_1cheat_native_1codec_1minimized_Main_createStreamingMediaPlayer(JNIEnv* env,
...
void Java_com_cirosantilli_android_1cheat_native_1codec_1minimized_Main_setPlayingStreamingMediaPlayer(JNIEnv* env,
...
void Java_com_cirosantilli_android_1cheat_native_1codec_1minimized_Main_shutdown(JNIEnv* env, jclass clazz)
{
    LOGV("@@@ shutdown");
    if (mlooper) {
...
// set the surface
void Java_com_cirosantilli_android_1cheat_native_1codec_1minimized_Main_setSurface(JNIEnv *env, jclass clazz, jobject surface)
{
...
void Java_com_cirosantilli_android_1cheat_native_1codec_1minimized_Main_rewindStreamingMediaPlayer(JNIEnv *env, jclass clazz)
{
    LOGV("@@@ rewind");
