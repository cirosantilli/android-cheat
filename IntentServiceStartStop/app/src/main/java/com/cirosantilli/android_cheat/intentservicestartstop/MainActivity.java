package com.cirosantilli.android_cheat.intentservicestartstop;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                */
                MainActivity.this.startService(intent.putExtra(MainActivity.EXTENDED_DATA_STATUS, MainActivity.this.i));
            }
        });
        ...
        LocalBroadcastManager.getInstance(this).registerReceiver(
                new BroadcastReceiver() {
                    ...
                    public void onReceive(Context context, Intent intent) {
                        MainActivity.this.i = intent.getIntExtra(MainActivity.EXTENDED_DATA_STATUS, 0);
                        textView.setText(Integer.toString(MainActivity.this.i));
                    }
    ...
    public static class MyService extends IntentService {
        ...
        protected void onHandleIntent(Intent intent) {
            ...
            this.i = intent.getIntExtra(MainActivity.EXTENDED_DATA_STATUS, 0);
            this.done = false;
            while(!done) {
                ...
                LocalBroadcastManager.getInstance(this).sendBroadcast(
                        ...
                        .putExtra(MainActivity.EXTENDED_DATA_STATUS, MyService.this.i));
                this.i++;
            }
        }
        @Override
