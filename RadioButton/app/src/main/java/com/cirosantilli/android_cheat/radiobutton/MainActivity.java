package com.cirosantilli.android_cheat.radiobutton;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(MainActivity.TAG, Integer.toString(radioGroup.getCheckedRadioButtonId()));
        Log.d(MainActivity.TAG, Integer.toString(radioButton1.getId()));
    ...
    private void setText(TextView textView, int checkedId) {
        Log.d(MainActivity.TAG, Integer.toString(checkedId));
        Log.d(MainActivity.TAG, Boolean.toString(this.findViewById(checkedId) == null));
